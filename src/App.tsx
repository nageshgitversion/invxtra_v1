...
export default function App() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'portfolio': return <Portfolio holdings={holdings} setActiveTab={setActiveTab} onBack={() => setActiveTab('vault')} />;
      ...
      case 'taxplanner': return <TaxPlanner onBack={() => setActiveTab('insights')} />;
